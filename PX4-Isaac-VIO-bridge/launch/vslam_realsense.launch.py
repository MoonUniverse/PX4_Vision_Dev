...
def generate_launch_description():
    ...
    # return launch.LaunchDescription([realsense_camera_node, camera_link_gyro_tf_node, gyro_optical_tf_node, vio_transform_node, foxglove_bridge_node])
    return launch.LaunchDescription([camera_link_gyro_tf_node, gyro_optical_tf_node, vio_transform_node, foxglove_bridge_node])